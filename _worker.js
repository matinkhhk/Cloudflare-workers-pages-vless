...
let userID = '9a8f7c8b-9465-4398-973b-da4b32d49416';

const proxyIPs = ['cdn.xn--b6gac.eu.org'];//['cdn.xn--b6gac.eu.org', 'cdn-all.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn-b100.xn--b6gac.eu.org'];

let proxyIP = proxyIPs[Math.floor(Math.random() * proxyIPs.length)];

let dohURL = 'https://dns.matinkheirollahi99.workers.dev'; // https://cloudflare-dns.com/dns-query or https://dns.google/dns-query
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						const hostnames = ['www.fmprc.gov.cn'];
