...
const proxyIPs = ['cdn-all.xn--b6gac.eu.org' , 'cdn-b100.xn--b6gac.eu.org'];

let proxyIP = proxyIPs[Math.floor(Math.random() * proxyIPs.length)];

let dohURL = 'https://2ofjba1w7b.cloudflare-gateway.com/dns-query'; // https://cloudflare-dns.com/dns-query or https://dns.google/dns-query
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						const hostnames = ['www.fmprc.gov.cn , www.digikala.com , www.shopshopslive.com'];
